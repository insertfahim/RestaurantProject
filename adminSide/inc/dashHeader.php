...
<html lang="en">
    <head>
        ...
        <script src="https:ppuse.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="../panel/pos-panel.php">Fahim's Staff Panel</a>
